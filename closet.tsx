...
const ClosetScreen = () => {
    ...
    const applyFilters = () => {
        const filteredClothes = clothes.filter(item => {
            ...
            const tempMatch = selectedTemperatures.length === 0 || selectedTemperatures.some(range => {
    ...
    const EditItemScreen = () => {
        ...
        <ScrollView>
            ...
            <Image source={{ uri: `data:image/jpeg;base64,${selectedItem.base64}` }} style={styles.preview} />
